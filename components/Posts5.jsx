...
import postImg3 from '../src/assets/veedu images/10015.jpg'
                    ...
                    <h6>{postInfo.propertDetails}</h6>
                            ...
                            <div id="carouselExample" class="carousel slide">
                                    <div class="carousel-inner">
                                        ...
                                        <img src={postImg2} class="d-block"  width='100%' height='300px'  alt="post image"/>
                                        </div>
                                        <div class="carousel-item">
                                        <img src={postImg3} class="d-block"  width='100%' height='300px'  alt="post image"/>
                                        </div>
                                    </div>
